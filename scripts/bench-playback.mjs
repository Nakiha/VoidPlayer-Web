...
const scenarios = process.env.BENCH_SCENARIOS ? JSON.parse(process.env.BENCH_SCENARIOS) : {
...
if (process.env.BENCH_REPORT) await writeFile(process.env.BENCH_REPORT, JSON.stringify(results, null, 2));
